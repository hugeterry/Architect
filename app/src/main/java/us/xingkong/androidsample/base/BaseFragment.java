...
import us.xingkong.androidsample.utils.ToastUtils;
...
public abstract class BaseFragment<P extends BasePresenter> extends Fragment
    ...
    public void showToast(CharSequence msg) {
        ToastUtils.shortToast(XingkongAPP.getAppContext(), msg);
    }

    @Override
    public void showToast(int msgId) {
        ToastUtils.shortToast(XingkongAPP.getAppContext(), msgId);
    }
